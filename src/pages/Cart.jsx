    ...
    return (
      ...
      <div className="container container--cart">
        <div className="cart">
          ...
          {pizzasTypes&&pizzasTypes.map((item,index)=>{
            return <CartItem key={item.name+index} name={item.name} size={item.activeSize} type={item.typeString} totalPrice={items[item.id].totalPrice} totalCount={items[item.id].items.length}/>
          })}
</div>  
